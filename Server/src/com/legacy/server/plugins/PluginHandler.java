...
public final class PluginHandler {
	...
	public void initPlugins() throws Exception {
		...
		List<Class<?>> actionClassFiles = ClassEnumerator.getPackageClasses(com.legacy.server.plugins.listeners.action.DropListener.class.getPackage());
		List<Class<?>> executiveClassFiles = ClassEnumerator.getPackageClasses(com.legacy.server.plugins.listeners.executive.DropExecutiveListener.class.getPackage());
