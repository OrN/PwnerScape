package com.pwns.server.plugins.npcs.tutorial;
...
public class Guide implements TalkToNpcExecutiveListener, TalkToNpcListener {
	...
	public void onTalkToNpc(Player p, Npc n) {
		...
		if(o == 0) {
			...
			ActionSender.sendBox(p, "Welcome to PwnerScape! % To speak on general chat type ::g <message> % @gre@The most populated city is Edgeville %"
