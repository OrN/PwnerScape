...
import com.pwns.server.external.CerterDef;
...
public class Certer implements TalkToNpcListener, TalkToNpcExecutiveListener {
	...
	public void onTalkToNpc(Player p, final Npc n) {
		...
		Functions.npcTalk(p, n, "Welcome to my " + certerDef.getType()
		+ " exchange stall");
		int option = Functions.showMenu(p, n, "I have some certificates to trade in",
				"I have some " + certerDef.getType() + " to trade in");
		switch (option) {
		case 0:
			p.message("What sort of certificate do you wish to trade in?");
			int index = Functions.showMenu(p, n, names);
			p.message("How many certificates do you wish to trade in?");
			int certAmount = Functions.showMenu(p, n, "One", "Two", "Three", "Four",
					"Five", "All to bank");
		...
		case 1:
			...
			index = Functions.showMenu(p, n, names);
			p.message("How many " + certerDef.getType()
			+ " do you wish to trade in?");
			certAmount = Functions.showMenu(p, n, "5", "10", "15", "20", "25",
					"All from bank");
