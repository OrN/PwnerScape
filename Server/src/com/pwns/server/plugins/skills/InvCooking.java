...
public class InvCooking implements InvUseOnItemListener, InvUseOnItemExecutiveListener {
	...
	public void onInvUseOnItem(Player player, Item item1, Item item2) {
		...
		if (item1.getID() == 143 && item2.getID() == 141
			...
			int option = Functions.showMenu(player, "Bread dough", "Pastry dough", "Pizza dough", "Pitta dough");
			...
			if (Functions.removeItem(player, new Item(waterContainer), new Item(136)) && productID > -1) {
