...
public class Drinkables implements InvActionListener, InvActionExecutiveListener {
	...
	public void onInvAction(Item item, Player player) {
		...
		case 1253:
			...
			int drink = Functions.showMenu(player,
					"Yes, I'm sure...",
			...
			if(drink == 0) {
				...
				Functions.playerTalk(player, null, "Mmmm.....");
				Functions.sleep(1100);
				player.message("It tastes sort of strange...like fried oranges...");
				Functions.playerTalk(player, null, ".....!.....");
				Functions.sleep(1100);
				Functions.message(player, 1300, "You feel somehow different...");
				Functions.playerTalk(player, null, "Let's just hope that this isn't a placibo!");
			} else if(drink == 1) {
