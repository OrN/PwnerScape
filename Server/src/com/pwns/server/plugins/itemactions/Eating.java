	...
	public void onInvAction(Item item, Player p) {
		if (item.isEdible()) {
			...
			if (item.getID() == 228 || item.getID() == 18) {
				...
				Functions.message(p, 1200, "You eat the gnome bowl");
				...
				Functions.message(p, "You eat the cheese and tomato batta");
