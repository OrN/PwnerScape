...
public final class Constants {
	...
	public static final class GameServer {
		 ...
		 * the servers name
		 */
		public static String SERVER_NAME = "PwnerScape";
		/**
		...
		/**
		 * Avatar directory : /usr/share/nginx/html/pwnerscape/img/playercard/
		 */
		public static final String AVATAR_DIR = "avatars" + File.separator;
