...
import com.pwns.server.model.PathValidation;
...
import com.pwns.server.sql.query.logs.TradeLog;
	...
	public void handlePacket(Packet p, Player player) throws Exception {
		...
		if (pID == packetOne) { // Sending trade request
			...
			if (affectedPlayer.getTrade().isTradeAccepted()) {
				...
				if (player.isSkulled() || affectedPlayer.isSkulled()) {
					if (player.isSkulled()) {
						player.message("@red@WARNING: If you accept this trade your skull will be extended");
					} else {
						player.message("@red@WARNING: If you accept this trade you will be skulled");
					}

					if (affectedPlayer.isSkulled()) {
						affectedPlayer.message("@red@WARNING: If you accept this trade your skull will be extended");
					} else {
						affectedPlayer.message("@red@WARNING: If you accept this trade you will be skulled");
					}
				}
			}
			...
			if (affectedPlayer.getTrade().isTradeConfirmAccepted()) {
				...
				// Skull players at end of trade if one of them is skulled
				if (player.isSkulled() || affectedPlayer.isSkulled()) {
					player.addSkull();
					affectedPlayer.addSkull();
				}
			}
