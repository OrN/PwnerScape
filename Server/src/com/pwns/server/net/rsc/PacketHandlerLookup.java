...
import com.pwns.server.net.rsc.handlers.AttackHandler;
import com.pwns.server.net.rsc.handlers.BankHandler;
import com.pwns.server.net.rsc.handlers.BlinkHandler;
import com.pwns.server.net.rsc.handlers.ChatHandler;
import com.pwns.server.net.rsc.handlers.CommandHandler;
import com.pwns.server.net.rsc.handlers.FriendHandler;
import com.pwns.server.net.rsc.handlers.GameObjectAction;
import com.pwns.server.net.rsc.handlers.GameObjectWallAction;
import com.pwns.server.net.rsc.handlers.GameSettingHandler;
import com.pwns.server.net.rsc.handlers.GroundItemTake;
import com.pwns.server.net.rsc.handlers.InterfaceOptionHandler;
import com.pwns.server.net.rsc.handlers.InterfaceShopHandler;
import com.pwns.server.net.rsc.handlers.ItemActionHandler;
import com.pwns.server.net.rsc.handlers.ItemDropHandler;
import com.pwns.server.net.rsc.handlers.ItemUseOnGroundItem;
import com.pwns.server.net.rsc.handlers.ItemUseOnItem;
import com.pwns.server.net.rsc.handlers.ItemUseOnNpc;
import com.pwns.server.net.rsc.handlers.ItemUseOnObject;
import com.pwns.server.net.rsc.handlers.ItemUseOnPlayer;
import com.pwns.server.net.rsc.handlers.ItemWieldHandler;
import com.pwns.server.net.rsc.handlers.Logout;
import com.pwns.server.net.rsc.handlers.LogoutRequest;
import com.pwns.server.net.rsc.handlers.MenuReplyHandler;
import com.pwns.server.net.rsc.handlers.NpcCommand;
import com.pwns.server.net.rsc.handlers.NpcTalkTo;
import com.pwns.server.net.rsc.handlers.Ping;
import com.pwns.server.net.rsc.handlers.PlayerAppearanceUpdater;
import com.pwns.server.net.rsc.handlers.PlayerDuelHandler;
import com.pwns.server.net.rsc.handlers.PlayerFollowRequest;
import com.pwns.server.net.rsc.handlers.PlayerTradeHandler;
import com.pwns.server.net.rsc.handlers.PrayerHandler;
import com.pwns.server.net.rsc.handlers.PrivacySettingHandler;
import com.pwns.server.net.rsc.handlers.ReportHandler;
import com.pwns.server.net.rsc.handlers.SleepHandler;
import com.pwns.server.net.rsc.handlers.SpellHandler;
import com.pwns.server.net.rsc.handlers.StyleHandler;
import com.pwns.server.net.rsc.handlers.TutorialHandler;
import com.pwns.server.net.rsc.handlers.WalkRequest;
